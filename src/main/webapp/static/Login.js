...
function create(){
    ...
    genderLabel = document.createElement("label");
        ...
        genderLabel.innerHTML = "<h1>Male:</h1>";
...
function createAccount(){
    ...
    if((passwordField.value + passwordField2.value + loginField.value) == ""){
    ...
    var xhr = new XMLHttpRequest();
        ...
        var mes = "login=" + loginField.value + "&password=" + passwordField.value + "&create=true";
        xhr.send(mes);
}
